...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex mb-0 mt-0">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 gap-4 items-center justify-between pt-4 pb-2 font-normal transition-all hover:underline [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
