    ...
    <section>
      ...
      <Form {...profileForm}>
        ...
        >
          <PreSectionForm />
          <PersonalDataSection />
          <LanguagesAndRegionSection />
          <GoUsersSection
            initialGoUsers={initialValues?.go_users}
          />
          <SocialsSection />
...
function PreSectionForm() {
  const profileForm =
    useFormContext<ProfileFormValidation>()
  ...
  return (
    <fieldset className="grid grid-cols-2 gap-x-2 gap-y-3">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="ml-3">Sexo</FormLabel>
            <Select
...
function LanguagesAndRegionSection() {
  const profileForm =
    useFormContext<ProfileFormValidation>()
...
type GoUsersSectionProps = {
  initialGoUsers: GoUsers | null | undefined
}

function GoUsersSection({
  initialGoUsers,
}: GoUsersSectionProps) {
  const profileForm =
    useFormContext<ProfileFormValidation>()
  ...
  return (
    <fieldset>
      ...
      <p className="ml-3 text-sm mb-2 text-gray-600">
        A força que aparecerá ao lado do seu nome no perfil
